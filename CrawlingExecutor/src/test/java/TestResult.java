public class TestResult {
    ...
    public static final String result =
        """
            ...
            무도한 감사원 행패, 조은석 견뎌
            내란특검, 계엄령 근본부터 밝혀야
            ◇ 박재홍> 3대 특검이 수사 준비에 박차를 가하고 있습니다. 내란 특검을 맡고 있는 조은석 특검 출범 6일 만에 전격적으로 김용현 전 국방부 장관을 추가 기소했죠. 아울러 나머지 두 특검도 특검보 후보자 명단을 제출한 상황입니다. 본격적으로 가동이 될 것 같은데 오랜만에 이분 모시고 말씀 나눠보겠습니다. 돌아온 한판내부자 구용회 CBS 전 논설위원 어서 오세요.
            ◆ 구용회> 안녕하세요. 오랜만입니다.
            ◇ 박재홍> 잘 지내셨죠?
            ...
            ◆ 구용회> 그러니까 저도 내부 사정은 정확히 알 수가 없었고 사실은 그게 전현희 전 장관에 대한 감찰 때문에 불거졌잖아요. 그런데 저도 사실은 내부 사정을 속속들이 알 수는 없잖아요. 그런데 제가 사실은 조은석 당시 감사위원에 대해서 그다음에 조은석이라는 인물에 대해서 다시 한번 생각하게 된 계기는 있었어요. 그게 뭐냐 하면 헌법재판소에서 최재해 감사원장에 대한 탄핵 재판이 있었잖아요. 그런데 거기에 김숙동 이른바 아까 타이거파의 핵심이라고 하죠. 본인은 타이거파는 없다는 거예요.
            ◇ 박재홍> 특별조사국장.
